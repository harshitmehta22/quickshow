...
const AddShows = () => {
    ...
    return nowPlayingMovies.length >0 ? (
        ...
        <div className="overflow-x-auot pb-4">
...
<div className="mt-6">
    <label className="block text-sm font-meduim mb-2">Select Date and Time</label>
    <div className="inline-flex gap-5 border border border-gray-600 p-1 pl-3 rounded-lg">
        ...
        {Object.entries(dateTimeSelection).map(([date,times]) => (
           <li key={date}>
            ...
            <div className="flex flex-wrap gap-2 mt-1 text-sm">
                {times?.map((time) => (
                    <div key={time} className="border border-priamry px-2 py-1 flex items-center rounded">
                        <span>{time}</span>
